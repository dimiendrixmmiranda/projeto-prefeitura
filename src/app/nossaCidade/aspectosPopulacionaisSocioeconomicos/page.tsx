...
export default function AspectosPopulacionaisSocioEconomicos() {
    return (
        <Template>
                ...
                <ul className="flex flex-col gap-6">
                    ...
                    <li className="flex flex-col gap-1 lg:grid lg:grid-cols-2">
                        ...
                        <div className="relative w-[300px] h-[300px] mx-auto">
                            <Image alt="Mapa de Joaquim Távora divisas" src={'/mapa-joaquim-tavora.png'} fill className="object-cover"></Image>
                        </div>
                    </li>
                </ul>
