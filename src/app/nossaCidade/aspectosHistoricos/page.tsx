            ...
            <div className="text-black p-2 max-w-[1200px] mx-auto">
                ...
                <ul className="flex flex-col gap-6">
                    <li className="flex flex-col gap-1 lg:grid lg:grid-cols-2">
                        ...
                        <div className=" w-full h-[300px] max-w-[450px] relative mx-auto lg:w-[400px] lg:h-[300px]">
                    ...
                    <li className="flex flex-col gap-1 lg:grid lg:grid-cols-2">
                        ...
                        <div className="w-full max-w-[450px] h-[300px] relative mx-auto lg:w-[300px] lg:h-[200px]">
