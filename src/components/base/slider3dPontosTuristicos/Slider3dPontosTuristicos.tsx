...
interface Slider3dPontosTuristicosProps {
    slides: PontoTuristico[];
}

export default function Slider3dPontosTuristicos({ slides }: Slider3dPontosTuristicosProps) {
    return (
        <div className="relative w-full p-4">
            ...
            >
                {slides.map((slide) => {
                    ...
                    return (
                        <SwiperSlide key={slide.id} className="!flex flex-col items-center border-2 border-verde-escuro">
                            <div
                                className="cursor-pointer w-full h-full"
                            >
                                <div className="w-full aspect-video rounded-lg overflow-hidden flex items-center justify-center text-white text-3xl font-bold">
                                    <img
                                        src={imagemCorrigida}
                                        alt={slide.nome}
